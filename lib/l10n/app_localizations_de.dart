...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String last_update(Object date) {
    return 'Preise aktualisiert am $date';
  }
  ...
  @override
  String get startup_check_resources => 'Ressourcen werden abgerufen...';
  ...
  @override
  String get settings_filter_brands => 'Bevorzugte Marken';
  ...
  String settings_brands_selected(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Marken ausgewählt',
      one: '1 Marke ausgewählt',
    );
    return '$_temp0';
  }

  @override
  String get settings_brands_all_selected => 'Alle Marken';

  @override
  String get settings_select_brands_dialog_title => 'Marken auswählen';

  @override
  String get search_brands_placeholder => 'Marke suchen...';

  @override
  String get settings_setting_unavailable => 'Option nicht verfügbar';

  @override
  String get settings_fuel_consumption_title => 'Durchschnittsverbrauch';

  @override
  String get settings_fuel_consumption_subtitle =>
      'Geben Sie den Verbrauch Ihres Fahrzeugs ein';
